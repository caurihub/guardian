...
export const initApp = (): Application => {
    ...
    app.bind(Container.Identifiers.TransactionHandler).to(GuardianUserPermissionsHandler);
    app.bind(Container.Identifiers.TransactionHandler).to(GuardianGroupPermissionsHandler);
